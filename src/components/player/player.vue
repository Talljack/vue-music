  ...
  <div class="player" v-show="playlist.length > 0">
        ...
        >
            <div class="middle-l" ref="middleL">
              <div class="cd-wrapper" ref="cdWrapper">
                <div class="cd" :class="playRotate" :key="currentSong.image">
        ...
        <div class="bottom">
            ...
            <div class="progress-wrapper">
              ...
              <div class="progress-bar-wrapper">
                <progress-bar :precent='precent' @progressPrecent='progressPrecentChange'></progress-bar>
              </div>
    ...
    <transition class="mini">
      <div class="mini-player" v-show="!fullscreen" @click="open">
        <div class="icon">
          <img class="image" :class="playRotate" width="40" height="40" :src="currentSong.image">
        </div>
        <div class="text">
        ...
        <div class="control">
          ...
          <progress-circle :radius='radius' :precent='precent'>
            <i class="icon-mini" :class="playIconMini" @click.prevent.stop="togglePlay"></i>
          </progress-circle>
        </div>
    ...
    <audio preload="auto" ref="audio" :src="currentSong.url" @play="ready" @error="error" @timeupdate="updateTime" @ended="end"></audio>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    _getPos() {
      ...
      let x = -(window.innerWidth / 2 - paddingLeft - smallWidth / 2)
      let y = window.innerHeight - paddingTop - paddingBottom - smallWidth / 2 - bigWidth / 2
      return {
        x,
        y,
        scale
