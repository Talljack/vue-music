      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          ...
          <scroll :refreshDelay='refreshDelay' ref="searchList" class="list-scroll" v-if="currentIndex === 1" :data='searchHistory'>
            <div class="list-inner">
              <search-list :searches='searchHistory' :select='selectSearch' @delete='deleteSearchHistory'></search-list>
            </div>
          </scroll>
        </div>
      </div>
      <div class="search-result" v-show="query">
        <suggest :showSinger='showSinger' ref="suggest" @blurInput='blurInput' :query='query' @select="selectSuggest"></suggest>
      </div>
      <top-tip ref="topTip">
        <div class="tip-title">
          <i class="icon-ok"></i>
